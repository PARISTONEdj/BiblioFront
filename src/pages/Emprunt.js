...
function Emprunt(){
    ...
    useEffect(() => {
              ...
              fetch('http://localhost:5000/emprunt/liste/')
      ...
      const effectuerRecherche=(event)=>{
        ...
        if(recherche ==""){
            ...
            fetch(`http://localhost:5000/emprunt/recherches/${recherche}`)
            .then((response) => response.json())
            .then((data) => {
               setEmprunts(data); 
              setLoading(false);
                ...
                <div className="items-start justify-between md:flex">
                    <div className="max-w-lg">
                        ...
                        <p className="text-gray-600 mt-2">
                            La liste des emprunts de livre de la bibliotheque
                        </p>
                    </div>
                ...
                <form
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="text"
                                placeholder="Search ..Entrer le nom de l'adherant ou du livre"
